...
- Completed task log: `docs/status-docs/COMPLETED.md`

Completion workflow: when a task is done, remove it from this file and move it to `COMPLETED.md`.
...
When these tasks are completed add to COMPLETED.md
...
When each task is completed, add to COMPLETED.md:
