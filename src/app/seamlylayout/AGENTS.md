# SeamlyLayout Workspace Instructions for Agents

Author: slspencer
Copyright: 2026

> Synchronization note: This file mirrors `.github/copilot-instructions.md`. If content diverges, treat `.github/copilot-instructions.md` as the source of truth and sync this file.
