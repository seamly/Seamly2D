...
# SUBDIRS lists the two direct children of this project: the source
# tree `src` (utilized by all builds, windows/linux/macos)
# and the macOS packaging tree `packaging_macos`, required only by the macos build. 
...
# ===== qmake, hdiutil, & racing condition for macos build =====
