...
- **Every package carries all three apps.** There is no switch for a two-app package. `test_msi_authoring.ps1` asserts the SeamlyLayout shortcut and icon unconditionally.
