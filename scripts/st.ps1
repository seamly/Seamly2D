...
.DESCRIPTION
    ...
    (<repo-root>\seamly2d-build-debug\), or the release build\ tree with
    -Release. Build first with scripts\sd.ps1 — this script only runs.
...
param(
    # When set, use the release build\ tree instead of seamly2d-build-debug\.
    [switch]$Release,
